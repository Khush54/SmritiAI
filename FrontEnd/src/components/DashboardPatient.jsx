...
const DashboardPage = ({ setPage }) => {
  ...
  // 1. Dynamic State: Isse data update hote hi UI change hoga
  ...
  }, [userStats]); // Jab bhi userStats badlega, charts re-render honge

  return (
    <div className="page dashboard-container">
      <div className="section-header">
        <div>
          <h1 className="section-title">Good morning, Ramesh 👋</h1>
          <p className="section-sub">Cognitive health overview for **Smriti AI**</p>
        </div>
        
        {/* Testing ke liye Dynamic Button (Real app mein ye Test completion ke baad hoga) */}
